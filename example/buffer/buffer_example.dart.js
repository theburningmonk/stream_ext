...
StreamExt_buffer: function(input, duration, closeOnError, sync) {
  var controller, onError, buffer, t1, t2, t3;
  ...
  buffer = $.List_List(null);
  t1 = new $.StreamExt_buffer_pushBuffer(controller, buffer);
  t2 = new $._PeriodicZoneTimer($.get$_Zone__current(), new $.StreamExt_buffer_closure(t1), null);
  t3 = t2._zone;
  t3._openCallbacks = t3._openCallbacks + 1;
  t2._timer = $._createPeriodicTimer(duration, t2.get$_run());
  input.listen$3$onDone$onError(C.JSArray_methods.get$add(buffer), new $.StreamExt_buffer_closure0(controller, t1), onError);
...
StreamExt_buffer_pushBuffer: {"": "Closure;controller_0,buffer_1",
  call$0: function() {
    var t1, t2, t3, t4;
    t1 = this.buffer_1;
    if (t1.length > 0) {
      t2 = this.controller_0;
      t3 = $.List_List$from(t1, true);
      t4 = t2._state;
      if ((t4 & 4) === 0) {
        if (t4 >= 4)
...
StreamExt_buffer_closure: {"": "Closure;pushBuffer_2",
  call$1: function(_) {
    return this.pushBuffer_2.call$0();
  }
},

StreamExt_buffer_closure0: {"": "Closure;controller_3,pushBuffer_4",
  call$0: function() {
    this.pushBuffer_4.call$0();
    var t1 = this.controller_3;
    if ((t1._state & 4) === 0)
      t1.close$0(t1);
  }
}}],
["window_example", "buffer_example.dart", , {
main: function() {
  var t1, btn1, btnErr1, btnDone1, output, contrl, input, buffers, t2, t3;
  t1 = {};
  ...
  contrl = $.StreamController_StreamController$broadcast(null, null, false);
  input = new $._BroadcastStream(contrl);
  buffers = $.StreamExt_buffer(input, $.Duration$(0, 0, 0, 0, 0, 3), false, false);
  t2 = new $.main_log(output);
  input.listen$3$onDone$onError(new $.main_closure(t2), new $.main_closure0(t2), new $.main_closure1(t2));
  buffers.listen$3$onDone$onError(new $.main_closure2(t2), new $.main_closure3(t2), new $.main_closure4(t2));
  t1.idx_0 = 0;
  btn1.get$onClick;
  ...
  new $._EventStreamSubscription(0, t3._target, t3._eventType, new $.main_closure5(t1, contrl), t3._useCapture)._tryResume$0();
  btnErr1.get$onClick;
  t3 = new $._ElementEventStreamImpl(btnErr1, t2, false);
  new $._EventStreamSubscription(0, t3._target, t3._eventType, new $.main_closure6(contrl), t3._useCapture)._tryResume$0();
  btnDone1.get$onClick;
  t2 = new $._ElementEventStreamImpl(btnDone1, t2, false);
  new $._EventStreamSubscription(0, t2._target, t2._eventType, new $.main_closure7(contrl), t2._useCapture)._tryResume$0();
},
...
main_closure: {"": "Closure;log_2",
  call$1: function(x) {
    return this.log_2.call$2("input", x);
  }
},

main_closure1: {"": "Closure;log_3",
  call$1: function(err) {
    return this.log_3.call$2("input", err);
  }
},

main_closure0: {"": "Closure;log_4",
  call$0: function() {
    return this.log_4.call$2("input", "done");
  }
},

main_closure2: {"": "Closure;log_5",
  call$1: function(x) {
    return this.log_5.call$2("window", x);
  }
},

main_closure4: {"": "Closure;log_6",
  call$1: function(err) {
    return this.log_6.call$2("window", err);
  }
},

main_closure3: {"": "Closure;log_7",
  call$0: function() {
    return this.log_7.call$2("window", "done");
  }
},

main_closure5: {"": "Closure;box_0,contrl_8",
  call$1: function(_) {
    var t1, t2, t3;
    t1 = this.contrl_8;
    t2 = this.box_0;
    t3 = t2.idx_0;
    t2.idx_0 = $.$add$ns(t3, 1);
    if (t1._state >= 4)
...
main_closure6: {"": "Closure;contrl_9",
  call$1: function(_) {
    return this.contrl_9.addError$1("new error");
  }
},

main_closure7: {"": "Closure;contrl_10",
  call$1: function(_) {
    var t1 = this.contrl_10;
...
//# sourceMappingURL=buffer_example.dart.js.map
//@ sourceMappingURL=buffer_example.dart.js.map
