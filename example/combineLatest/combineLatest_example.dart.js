...
["combineLatest_example", "combineLatest_example.dart", , {
main: function() {
  var t1, btn1, btn2, btnErr1, btnErr2, btnDone1, btnDone2, output, contr1, contr2, stream1, stream2, combined, t2, t3;
  t1 = {};
  ...
  combined = $.StreamExt_combineLatest(stream1, stream2, new $.main_closure(), false, false);
  t2 = new $.main_log(output);
  stream1.listen$3$onDone$onError(new $.main_closure0(t2), new $.main_closure1(t2), new $.main_closure2(t2));
  stream2.listen$3$onDone$onError(new $.main_closure3(t2), new $.main_closure4(t2), new $.main_closure5(t2));
  combined.listen$3$onDone$onError(new $.main_closure6(t2), new $.main_closure7(t2), new $.main_closure8(t2));
  t1.idx1_0 = 0;
  btn1.get$onClick;
  C.EventStreamProvider_click.forElement$2$useCapture;
  t2 = C.EventStreamProvider_click._eventType;
  t3 = new $._ElementEventStreamImpl(btn1, t2, false);
  new $._EventStreamSubscription(0, t3._target, t3._eventType, new $.main_closure9(t1, contr1), t3._useCapture)._tryResume$0();
  t1.idx2_1 = 0;
  btn2.get$onClick;
  t3 = new $._ElementEventStreamImpl(btn2, t2, false);
  new $._EventStreamSubscription(0, t3._target, t3._eventType, new $.main_closure10(t1, contr2), t3._useCapture)._tryResume$0();
  btnErr1.get$onClick;
  t3 = new $._ElementEventStreamImpl(btnErr1, t2, false);
  new $._EventStreamSubscription(0, t3._target, t3._eventType, new $.main_closure11(contr1), t3._useCapture)._tryResume$0();
  btnErr2.get$onClick;
  t3 = new $._ElementEventStreamImpl(btnErr2, t2, false);
  new $._EventStreamSubscription(0, t3._target, t3._eventType, new $.main_closure12(contr2), t3._useCapture)._tryResume$0();
  btnDone1.get$onClick;
  t3 = new $._ElementEventStreamImpl(btnDone1, t2, false);
  new $._EventStreamSubscription(0, t3._target, t3._eventType, new $.main_closure13(contr1), t3._useCapture)._tryResume$0();
  btnDone2.get$onClick;
  t2 = new $._ElementEventStreamImpl(btnDone2, t2, false);
  new $._EventStreamSubscription(0, t2._target, t2._eventType, new $.main_closure14(contr2), t2._useCapture)._tryResume$0();
},
...
main_log: {"": "Closure;output_1",
  call$2: function(prefix, value) {
    var t1, t2;
    t1 = $.get$children$x(this.output_1);
...
main_closure0: {"": "Closure;log_2",
  call$1: function(x) {
    return this.log_2.call$2("stream1", x);
  }
},

main_closure2: {"": "Closure;log_3",
  call$1: function(err) {
    return this.log_3.call$2("stream1", err);
  }
},

main_closure1: {"": "Closure;log_4",
  call$0: function() {
    return this.log_4.call$2("stream1", "done");
  }
},

main_closure3: {"": "Closure;log_5",
  call$1: function(x) {
    return this.log_5.call$2("stream2", x);
  }
},

main_closure5: {"": "Closure;log_6",
  call$1: function(err) {
    return this.log_6.call$2("stream2", err);
  }
},

main_closure4: {"": "Closure;log_7",
  call$0: function() {
    return this.log_7.call$2("stream2", "done");
  }
},

main_closure6: {"": "Closure;log_8",
  call$1: function(x) {
    return this.log_8.call$2("combined", x);
  }
},

main_closure8: {"": "Closure;log_9",
  call$1: function(err) {
    return this.log_9.call$2("combined", err);
  }
},

main_closure7: {"": "Closure;log_10",
  call$0: function() {
    return this.log_10.call$2("combined", "done");
  }
},

main_closure9: {"": "Closure;box_0,contr1_11",
  call$1: function(_) {
    var t1, t2, t3;
    t1 = this.contr1_11;
    t2 = this.box_0;
    t3 = t2.idx1_0;
    t2.idx1_0 = $.$add$ns(t3, 1);
    if (t1._state >= 4)
...
main_closure10: {"": "Closure;box_0,contr2_12",
  call$1: function(_) {
    var t1, t2, t3;
    t1 = this.contr2_12;
    t2 = this.box_0;
    t3 = t2.idx2_1;
    t2.idx2_1 = $.$add$ns(t3, 1);
    if (t1._state >= 4)
      $.throwExpression(t1._addEventError$0());
    t1._sendData$1(t3);
    return;
...
main_closure11: {"": "Closure;contr1_13",
  call$1: function(_) {
    return this.contr1_13.addError$1("new error");
  }
},

main_closure12: {"": "Closure;contr2_14",
  call$1: function(_) {
    return this.contr2_14.addError$1("new error");
  }
},

main_closure13: {"": "Closure;contr1_15",
  call$1: function(_) {
    var t1 = this.contr1_15;
    return t1.close$0(t1);
  }
},

main_closure14: {"": "Closure;contr2_16",
  call$1: function(_) {
    var t1 = this.contr2_16;
    return t1.close$0(t1);
  }
}},
1],
...
StreamExt_combineLatest: function(stream1, stream2, selector, closeOnError, sync) {
  var t1, controller, completer1, completer2, onError, t2;
  t1 = {};
  ...
  t1.item1_0 = null;
  t1.item2_1 = null;
  t2 = new $.StreamExt_combineLatest_handleNewEvent(t1, selector, controller);
  stream1.listen$3$onDone$onError(new $.StreamExt_combineLatest_closure(t1, t2), completer1.get$complete(completer1), onError);
  stream2.listen$3$onDone$onError(new $.StreamExt_combineLatest_closure0(t1, t2), completer2.get$complete(completer2), onError);
  $._FutureImpl__FutureImpl$wait([completer1.future, completer2.future]).then$1(new $.StreamExt_combineLatest_closure1(controller));
...
StreamExt_combineLatest_handleNewEvent: {"": "Closure;box_0,selector_1,controller_2",
  call$0: function() {
    var t1, t2, t3;
    t1 = this.box_0;
    t2 = t1.item1_0;
    if (t2 != null && t1.item2_1 != null) {
      t3 = this.controller_2;
      t1 = this.selector_1.call$2(t2, t1.item2_1);
      t2 = t3._state;
      if ((t2 & 4) === 0) {
        if (t2 >= 4)
...
StreamExt_combineLatest_closure: {"": "Closure;box_0,handleNewEvent_3",
  call$1: function(x) {
    this.box_0.item1_0 = x;
    this.handleNewEvent_3.call$0();
  }
},

StreamExt_combineLatest_closure0: {"": "Closure;box_0,handleNewEvent_4",
  call$1: function(x) {
    this.box_0.item2_1 = x;
    this.handleNewEvent_4.call$0();
  }
},

StreamExt_combineLatest_closure1: {"": "Closure;controller_5",
  call$1: function(_) {
...
//# sourceMappingURL=combineLatest_example.dart.js.map
//@ sourceMappingURL=combineLatest_example.dart.js.map
