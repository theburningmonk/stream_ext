...
StreamExt_window: function(input, count, closeOnError, sync) {
  var controller, onError, elements;
  ...
  elements = $.List_List(null);
  input.listen$3$onDone$onError(new $.StreamExt_window_handleNewEvent(count, controller, elements), new $.StreamExt_window_closure(controller, elements), onError);
...
StreamExt_window_handleNewEvent: {"": "Closure;count_0,controller_1,elements_2",
  call$1: function(x) {
    var t1, t2, t3, t4;
    t1 = this.elements_2;
    t1.push(x);
    if (t1.length === this.count_0) {
...
StreamExt_window_closure: {"": "Closure;controller_3,elements_4",
  call$0: function() {
    var t1, t2, t3;
    t1 = this.elements_4;
    if (t1.length > 0) {
      t2 = this.controller_3;
      t1 = $.List_List$from(t1, true);
      t3 = t2._state;
      if ((t3 & 4) === 0) {
        if (t3 >= 4)
          $.throwExpression(t2._addEventError$0());
...
["window_example", "window_example.dart", , {
main: function() {
  var t1, btn1, btnErr1, btnDone1, output, contrl, input, windows, t2, t3;
  t1 = {};
  ...
  windows = $.StreamExt_window(input, 3, false, false);
  t2 = new $.main_log(output);
  input.listen$3$onDone$onError(new $.main_closure(t2), new $.main_closure0(t2), new $.main_closure1(t2));
  windows.listen$3$onDone$onError(new $.main_closure2(t2), new $.main_closure3(t2), new $.main_closure4(t2));
  t1.idx_0 = 0;
  btn1.get$onClick;
...
//# sourceMappingURL=window_example.dart.js.map
//@ sourceMappingURL=window_example.dart.js.map
